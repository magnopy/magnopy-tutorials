...
.. admonition:: Tutorial tasks
    ...
    *   Optimize the Hamiltonian on several super-cells. Are there any changes of the
        ground state?
    *   Optimize with different directions and values of the external magnetic field.
...
*   ``> console-output.txt``
    ...
    Redirects text output of magnopy and saves it to the file "console-output.txt", that
...
*   "INITIAL_GUESS.txt"
    ...
    This file describes the initial guess for spin directions that was used by the
